...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = self.P_CENTERS or {
        ...
        b_yellow=           {name = "Yellow Deck",      stake = 1, demo = false,unlocked = false, start_locked = true, order = 3, pos =  {x=1,y=2}, set = "Back", config = {dollars = 50}, unlock_condition = {type = 'discover_amount', amount = self.FTP_LOCKED and 20 or 50}},
