...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = self.P_CENTERS or {
        ...
        b_red=              {name = "Red Deck",         stake = 1, demo = false,unlocked = true,order = 1, pos =   {x=0,y=0}, set = "Back", config = {discards = 3, hands = 5}, discovered = true, start_discovered = true},
        ...
        b_ghost=            {name = "Ghost Deck",       stake = 1, demo = true, unlocked = false, start_locked = true, order = 8, pos =  {x=6,y=2}, set = "Back", config = {spectral_rate = 4, consumables = {'c_hex'}}, unlock_condition = {type = 'win_deck', deck = 'b_yellow'}},
        ...
        b_anaglyph=         {name = "Anaglyph Deck",    stake = 1, demo = true, unlocked = false, start_locked = true, order = 13, pos = {x=2,y=4}, set = "Back", config = {consumables = {'c_sigil','c_ouija'}}, unlock_condition = {type = 'win_stake', stake = 4}},
...
function Game:main_menu(change_context) --True if main menu is accessed from the splash screen, false if it is skipped or accessed from the game
    ...
    G.E_MANAGER:add_event(Event({
        ...
        func = (function()
                set_main_menu_UI()
                if love.platform.requestTrackingPermission then love.platform.requestTrackingPermission() end
...
function Game:update(dt)
    ...
    if love.platform.setProfileButtonActive then
