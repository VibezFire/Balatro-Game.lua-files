...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = self.P_CENTERS or {
        ...
        b_ghost=            {name = "Ghost Deck",       stake = 1, demo = true, unlocked = false, start_locked = true, order = 8, pos =  {x=6,y=2}, set = "Back", config = {spectral_rate = 2, consumables = {'c_ouija','c_sigil'}}, unlock_condition = {type = 'win_deck', deck = 'b_yellow'}},
